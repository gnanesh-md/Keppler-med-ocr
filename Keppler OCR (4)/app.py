...
def main():
    if not st.session_state.logged_in:
        ...
        with st.sidebar:
            ...
            menu_options = ["Home", "Universal OCR", "PDF Summarizer", "Drug CDSS", "Document Vault"]
        ...
        if st.session_state.current_app == "Home":
            ...
            # Get list of installed models – simplified to avoid blocking UI
            installed_models = []  # No model detection; UI will show offline status
        ...
        # --- 2.5 PDF SUMMARIZER ---
        elif st.session_state.current_app == "PDF Summarizer":
            from modules.pdf_summarizer import render_pdf_summarizer
            render_pdf_summarizer()
            
        # --- 2.6 DRUG CDSS ---
        elif st.session_state.current_app == "Drug CDSS":
            from modules.drug_cdss import render_drug_cdss
            render_drug_cdss()
